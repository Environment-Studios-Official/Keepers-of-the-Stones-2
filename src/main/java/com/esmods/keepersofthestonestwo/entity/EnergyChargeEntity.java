...
public class EnergyChargeEntity extends AbstractArrow implements ItemSupplier {
	...
	public EnergyChargeEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(PowerModEntities.ENERGY_CHARGE.get(), world);
	}
	...
	public EnergyChargeEntity(EntityType<? extends EnergyChargeEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public EnergyChargeEntity(EntityType<? extends EnergyChargeEntity> type, LivingEntity entity, Level world) {

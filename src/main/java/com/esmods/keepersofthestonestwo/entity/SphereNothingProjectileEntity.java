...
public class SphereNothingProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public SphereNothingProjectileEntity(EntityType<? extends SphereNothingProjectileEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public SphereNothingProjectileEntity(EntityType<? extends SphereNothingProjectileEntity> type, LivingEntity entity, Level world) {

...
public class WheelAbilitiesExplosionButtonMessage {
	private final int buttonID, x, y, z;

	public WheelAbilitiesExplosionButtonMessage(FriendlyByteBuf buffer) {
	...
	public WheelAbilitiesExplosionButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(WheelAbilitiesExplosionButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(WheelAbilitiesExplosionButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesExplosionButtonMessage.class, WheelAbilitiesExplosionButtonMessage::buffer, WheelAbilitiesExplosionButtonMessage::new, WheelAbilitiesExplosionButtonMessage::handler);
	}
}

...
public class WheelAbilitiesMistButtonMessage {
	private final int buttonID, x, y, z;

	public WheelAbilitiesMistButtonMessage(FriendlyByteBuf buffer) {
	...
	public WheelAbilitiesMistButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(WheelAbilitiesMistButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(WheelAbilitiesMistButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesMistButtonMessage.class, WheelAbilitiesMistButtonMessage::buffer, WheelAbilitiesMistButtonMessage::new, WheelAbilitiesMistButtonMessage::handler);
	}
}

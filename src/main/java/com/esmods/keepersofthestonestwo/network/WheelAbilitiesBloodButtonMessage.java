...
public class WheelAbilitiesBloodButtonMessage {
	private final int buttonID, x, y, z;

	public WheelAbilitiesBloodButtonMessage(FriendlyByteBuf buffer) {
	...
	public WheelAbilitiesBloodButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(WheelAbilitiesBloodButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(WheelAbilitiesBloodButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesBloodButtonMessage.class, WheelAbilitiesBloodButtonMessage::buffer, WheelAbilitiesBloodButtonMessage::new, WheelAbilitiesBloodButtonMessage::handler);
	}
}

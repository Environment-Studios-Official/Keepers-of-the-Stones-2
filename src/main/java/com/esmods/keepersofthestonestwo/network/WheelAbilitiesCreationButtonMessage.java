...
public class WheelAbilitiesCreationButtonMessage {
	private final int buttonID, x, y, z;

	public WheelAbilitiesCreationButtonMessage(FriendlyByteBuf buffer) {
	...
	public WheelAbilitiesCreationButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(WheelAbilitiesCreationButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(WheelAbilitiesCreationButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesCreationButtonMessage.class, WheelAbilitiesCreationButtonMessage::buffer, WheelAbilitiesCreationButtonMessage::new, WheelAbilitiesCreationButtonMessage::handler);
	}
}

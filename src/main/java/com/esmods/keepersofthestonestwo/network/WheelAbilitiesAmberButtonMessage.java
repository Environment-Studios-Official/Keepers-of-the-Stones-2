...
public class WheelAbilitiesAmberButtonMessage {
	private final int buttonID, x, y, z;

	public WheelAbilitiesAmberButtonMessage(FriendlyByteBuf buffer) {
	...
	public WheelAbilitiesAmberButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(WheelAbilitiesAmberButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(WheelAbilitiesAmberButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesAmberButtonMessage.class, WheelAbilitiesAmberButtonMessage::buffer, WheelAbilitiesAmberButtonMessage::new, WheelAbilitiesAmberButtonMessage::handler);
	}
}

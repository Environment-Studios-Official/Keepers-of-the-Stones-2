...
public class WheelAbilitiesMoonButtonMessage {
	...
	public WheelAbilitiesMoonButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(WheelAbilitiesMoonButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(WheelAbilitiesMoonButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesMoonButtonMessage.class, WheelAbilitiesMoonButtonMessage::buffer, WheelAbilitiesMoonButtonMessage::new, WheelAbilitiesMoonButtonMessage::handler);
	}
}

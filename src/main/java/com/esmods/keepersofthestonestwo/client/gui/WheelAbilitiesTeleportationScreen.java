...
public class WheelAbilitiesTeleportationScreen extends AbstractContainerScreen<WheelAbilitiesTeleportationMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 22 && mouseY < topPos + 46)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_teleportation.tooltip_creating_checkpoint_uses_40"), mouseX, mouseY);
		if (mouseX > leftPos + 144 && mouseX < leftPos + 168 && mouseY > topPos + 84 && mouseY < topPos + 108)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_teleportation.tooltip_return_to_checkpoint_uses_40"), mouseX, mouseY);
		if (mouseX > leftPos + 83 && mouseX < leftPos + 107 && mouseY > topPos + 145 && mouseY < topPos + 169)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_teleportation.tooltip_creatingdestructing_portals_us"), mouseX, mouseY);
	}

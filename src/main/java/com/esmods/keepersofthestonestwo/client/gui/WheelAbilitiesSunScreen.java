...
public class WheelAbilitiesSunScreen extends AbstractContainerScreen<WheelAbilitiesSunMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 22 && mouseY < topPos + 46)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_sun.tooltip_sun_ray_uses_15"), mouseX, mouseY);
		if (mouseX > leftPos + 144 && mouseX < leftPos + 168 && mouseY > topPos + 82 && mouseY < topPos + 106)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_sun.tooltip_sun_explosion_uses_45"), mouseX, mouseY);
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 146 && mouseY < topPos + 170)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_sun.tooltip_sun_healing_uses_80"), mouseX, mouseY);
	}

...
public class WheelAbilitiesCreationScreen extends AbstractContainerScreen<WheelAbilitiesCreationMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 144 && mouseY < topPos + 168)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_creation.tooltip_immortality_mark_uses_80"), mouseX, mouseY);
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 24 && mouseY < topPos + 48)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_creation.tooltip_four_elements_attack_uses_10"), mouseX, mouseY);
		if (mouseX > leftPos + 144 && mouseX < leftPos + 168 && mouseY > topPos + 84 && mouseY < topPos + 108)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_creation.tooltip_supertool_uses_50"), mouseX, mouseY);
	}

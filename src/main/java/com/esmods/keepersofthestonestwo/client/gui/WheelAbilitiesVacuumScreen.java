...
public class WheelAbilitiesVacuumScreen extends AbstractContainerScreen<WheelAbilitiesVacuumMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 83 && mouseX < leftPos + 107 && mouseY > topPos + 23 && mouseY < topPos + 47)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_vacuum.tooltip_sphere_of_nothing_uses_20"), mouseX, mouseY);
		if (mouseX > leftPos + 144 && mouseX < leftPos + 168 && mouseY > topPos + 84 && mouseY < topPos + 108)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_vacuum.tooltip_rifts_uses_45"), mouseX, mouseY);
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 144 && mouseY < topPos + 168)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_vacuum.tooltip_zeroing_out_uses_100"), mouseX, mouseY);
	}

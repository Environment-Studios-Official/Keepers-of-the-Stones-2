...
public class WheelAbilitiesTimeScreen extends AbstractContainerScreen<WheelAbilitiesTimeMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 22 && mouseY < topPos + 46)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_time.tooltip_stopping_time_uses_30"), mouseX, mouseY);
		if (mouseX > leftPos + 144 && mouseX < leftPos + 168 && mouseY > topPos + 84 && mouseY < topPos + 108)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_time.tooltip_time_dilation_uses_30"), mouseX, mouseY);
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 146 && mouseY < topPos + 170)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_time.tooltip_acceleration_of_time_uses_30"), mouseX, mouseY);
	}

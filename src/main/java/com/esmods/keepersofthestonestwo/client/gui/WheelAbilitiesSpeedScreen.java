...
public class WheelAbilitiesSpeedScreen extends AbstractContainerScreen<WheelAbilitiesSpeedMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 21 && mouseY < topPos + 45)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_speed.tooltip_dash_uses_20"), mouseX, mouseY);
		if (mouseX > leftPos + 145 && mouseX < leftPos + 169 && mouseY > topPos + 84 && mouseY < topPos + 108)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_speed.tooltip_acceleration_uses_45"), mouseX, mouseY);
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 145 && mouseY < topPos + 169)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_speed.tooltip_deceleration_uses_70"), mouseX, mouseY);
	}

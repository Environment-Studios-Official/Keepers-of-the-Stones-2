...
public class WheelAbilitiesBloodScreen extends AbstractContainerScreen<WheelAbilitiesBloodMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 81 && mouseX < leftPos + 105 && mouseY > topPos + 22 && mouseY < topPos + 46)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_blood.tooltip_bleeding_uses_15"), mouseX, mouseY);
		if (mouseX > leftPos + 144 && mouseX < leftPos + 168 && mouseY > topPos + 84 && mouseY < topPos + 108)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_blood.tooltip_vampirism_uses_40"), mouseX, mouseY);
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 146 && mouseY < topPos + 170)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_blood.tooltip_transfusion_uses_40"), mouseX, mouseY);
	}

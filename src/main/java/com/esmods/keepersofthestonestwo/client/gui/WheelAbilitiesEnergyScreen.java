...
public class WheelAbilitiesEnergyScreen extends AbstractContainerScreen<WheelAbilitiesEnergyMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 22 && mouseY < topPos + 46)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_energy.tooltip_energy_flux_uses_10"), mouseX, mouseY);
		if (mouseX > leftPos + 144 && mouseX < leftPos + 168 && mouseY > topPos + 84 && mouseY < topPos + 108)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_energy.tooltip_energy_charged_ball_uses_35"), mouseX, mouseY);
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 144 && mouseY < topPos + 168)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_energy.tooltip_energy_charge_uses_80"), mouseX, mouseY);
	}

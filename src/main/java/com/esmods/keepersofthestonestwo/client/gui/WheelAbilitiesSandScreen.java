...
public class WheelAbilitiesSandScreen extends AbstractContainerScreen<WheelAbilitiesSandMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 83 && mouseX < leftPos + 107 && mouseY > topPos + 23 && mouseY < topPos + 47)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_sand.tooltip_sand_jet_uses_15"), mouseX, mouseY);
		if (mouseX > leftPos + 144 && mouseX < leftPos + 168 && mouseY > topPos + 85 && mouseY < topPos + 109)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_sand.tooltip_burial_uses_30"), mouseX, mouseY);
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 146 && mouseY < topPos + 170)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_sand.tooltip_sandstorm_uses_80"), mouseX, mouseY);
	}

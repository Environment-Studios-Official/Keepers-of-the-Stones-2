...
public class WheelAbilitiesTechnologyScreen extends AbstractContainerScreen<WheelAbilitiesTechnologyMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 24 && mouseY < topPos + 48)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_technology.tooltip_red_plasma_ball_uses_15"), mouseX, mouseY);
		if (mouseX > leftPos + 143 && mouseX < leftPos + 167 && mouseY > topPos + 84 && mouseY < topPos + 108)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_technology.tooltip_technobarrier_uses_60"), mouseX, mouseY);
		if (mouseX > leftPos + 83 && mouseX < leftPos + 107 && mouseY > topPos + 144 && mouseY < topPos + 168)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_technology.tooltip_turret_uses_80"), mouseX, mouseY);
	}

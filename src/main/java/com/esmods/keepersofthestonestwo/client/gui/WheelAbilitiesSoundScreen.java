...
public class WheelAbilitiesSoundScreen extends AbstractContainerScreen<WheelAbilitiesSoundMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 83 && mouseX < leftPos + 107 && mouseY > topPos + 22 && mouseY < topPos + 46)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_sound.tooltip_sound_wave_uses_10"), mouseX, mouseY);
		if (mouseX > leftPos + 144 && mouseX < leftPos + 168 && mouseY > topPos + 83 && mouseY < topPos + 107)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_sound.tooltip_sound_bomb_uses_30"), mouseX, mouseY);
		if (mouseX > leftPos + 83 && mouseX < leftPos + 107 && mouseY > topPos + 146 && mouseY < topPos + 170)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_sound.tooltip_sound_boom_uses_80"), mouseX, mouseY);
	}

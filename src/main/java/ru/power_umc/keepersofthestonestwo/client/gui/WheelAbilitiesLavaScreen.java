...
import ru.power_umc.keepersofthestonestwo.network.WheelAbilitiesLavaButtonMessage;
...
public class WheelAbilitiesLavaScreen extends AbstractContainerScreen<WheelAbilitiesLavaMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 23 && mouseY < topPos + 47)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_lava.tooltip_lava_outburst_uses_10"), mouseX, mouseY);
		if (mouseX > leftPos + 144 && mouseX < leftPos + 168 && mouseY > topPos + 83 && mouseY < topPos + 107)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_lava.tooltip_lava_attack_uses_35"), mouseX, mouseY);
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 144 && mouseY < topPos + 168)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_lava.tooltip_melting_uses_50"), mouseX, mouseY);
	}

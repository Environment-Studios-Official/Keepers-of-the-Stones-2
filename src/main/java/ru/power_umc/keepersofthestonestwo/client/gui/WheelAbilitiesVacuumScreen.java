...
public class WheelAbilitiesVacuumScreen extends AbstractContainerScreen<WheelAbilitiesVacuumMenu> {
	...
	public void init() {
		...
		button_1 = new Button(this.leftPos + 80, this.topPos + 24, 30, 20, Component.translatable("gui.power.wheel_abilities_vacuum.button_1"), e -> {
			if (true) {
		...
		button_2 = new Button(this.leftPos + 142, this.topPos + 86, 30, 20, Component.translatable("gui.power.wheel_abilities_vacuum.button_2"), e -> {
			if (true) {
		...
		button_3 = new Button(this.leftPos + 78, this.topPos + 146, 30, 20, Component.translatable("gui.power.wheel_abilities_vacuum.button_3"), e -> {
			if (true) {

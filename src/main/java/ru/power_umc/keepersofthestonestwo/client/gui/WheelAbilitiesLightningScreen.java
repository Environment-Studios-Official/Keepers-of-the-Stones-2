...
import ru.power_umc.keepersofthestonestwo.network.WheelAbilitiesLightningButtonMessage;
...
public class WheelAbilitiesLightningScreen extends AbstractContainerScreen<WheelAbilitiesLightningMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 23 && mouseY < topPos + 47)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_lightning.tooltip_electrical_discharges_uses_10"), mouseX, mouseY);
		if (mouseX > leftPos + 144 && mouseX < leftPos + 168 && mouseY > topPos + 83 && mouseY < topPos + 107)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_lightning.tooltip_lightning_strike_uses_35"), mouseX, mouseY);
		if (mouseX > leftPos + 83 && mouseX < leftPos + 107 && mouseY > topPos + 146 && mouseY < topPos + 170)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_lightning.tooltip_ball_lightning_uses_80"), mouseX, mouseY);
	}

...
import ru.power_umc.keepersofthestonestwo.network.WheelAbilitiesTornadoButtonMessage;
...
public class WheelAbilitiesTornadoScreen extends AbstractContainerScreen<WheelAbilitiesTornadoMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 23 && mouseY < topPos + 47)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_tornado.tooltip_mini_tornado_attack_uses_15"), mouseX, mouseY);
		if (mouseX > leftPos + 144 && mouseX < leftPos + 168 && mouseY > topPos + 82 && mouseY < topPos + 106)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_tornado.tooltip_tornado_capture_attack_uses_30"), mouseX, mouseY);
		if (mouseX > leftPos + 83 && mouseX < leftPos + 107 && mouseY > topPos + 145 && mouseY < topPos + 169)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_tornado.tooltip_tornado_flight_uses_5"), mouseX, mouseY);
	}

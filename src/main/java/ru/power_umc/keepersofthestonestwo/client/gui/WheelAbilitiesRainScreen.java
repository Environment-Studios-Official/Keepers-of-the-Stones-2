...
import ru.power_umc.keepersofthestonestwo.network.WheelAbilitiesRainButtonMessage;
...
public class WheelAbilitiesRainScreen extends AbstractContainerScreen<WheelAbilitiesRainMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 22 && mouseY < topPos + 46)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_rain.tooltip_rain_splash_uses_10"), mouseX, mouseY);
		if (mouseX > leftPos + 145 && mouseX < leftPos + 169 && mouseY > topPos + 83 && mouseY < topPos + 107)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_rain.tooltip_rain_curtain_uses_45"), mouseX, mouseY);
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 144 && mouseY < topPos + 168)
			this.renderTooltip(ms, Component.translatable("gui.power.wheel_abilities_rain.tooltip_rain_flying_uses_5"), mouseX, mouseY);
	}

...
import ru.power_umc.keepersofthestonestwo.procedures.LightballProjectileKoghdaSnariadPopadaietVSushchnostProcedure;
import ru.power_umc.keepersofthestonestwo.procedures.LightballProjectileKazhdyiTikPriPoliotieSnariadaProcedure;
...
public class LightballProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public LightballProjectileEntity(EntityType<? extends LightballProjectileEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public LightballProjectileEntity(EntityType<? extends LightballProjectileEntity> type, LivingEntity entity, Level world) {

...
import ru.power_umc.keepersofthestonestwo.procedures.BallLightningProjectileKoghdaSnariadPopadaietVSushchnostProcedure;
import ru.power_umc.keepersofthestonestwo.procedures.BallLightningProjectileKoghdaSnariadPopadaietVBlokProcedure;
import ru.power_umc.keepersofthestonestwo.procedures.BallLightningProjectileKazhdyiTikPriPoliotieSnariadaProcedure;
...
public class BallLightningProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public BallLightningProjectileEntity(EntityType<? extends BallLightningProjectileEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public BallLightningProjectileEntity(EntityType<? extends BallLightningProjectileEntity> type, LivingEntity entity, Level world) {

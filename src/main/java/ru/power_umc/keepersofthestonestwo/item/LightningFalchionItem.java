...
import ru.power_umc.keepersofthestonestwo.procedures.LightningFalchionKazhdyiTikVInvientarieProcedure;
...
public class LightningFalchionItem extends SwordItem {
	public LightningFalchionItem() {
		...
		}, 3, -1.92f, new Item.Properties().tab(null).fireResistant());
	}

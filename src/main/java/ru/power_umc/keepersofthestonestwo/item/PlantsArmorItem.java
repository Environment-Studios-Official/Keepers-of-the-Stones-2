...
import ru.power_umc.keepersofthestonestwo.procedures.PlantsArmorKazhdyiTikDliaShliemaProcedure;
import ru.power_umc.keepersofthestonestwo.procedures.PlantsArmorKazhdyiTikDliaPonozhieiProcedure;
import ru.power_umc.keepersofthestonestwo.procedures.PlantsArmorKazhdyiTikDliaNaghrudnikaProcedure;
import ru.power_umc.keepersofthestonestwo.procedures.PlantsArmorKazhdyiTikDliaBotinokProcedure;
...
public abstract class PlantsArmorItem extends ArmorItem {
	public PlantsArmorItem(EquipmentSlot slot, Item.Properties properties) {
